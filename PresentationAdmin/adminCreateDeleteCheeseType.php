                            ...
                            <div class="x_content">
                                <div class="bs-docs-section">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <form id="frmInformation" method="POST" action="../BusinessAdmin/CheeseTypeAction.php">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                <li role="presentation" class="active">
                                                    <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Tipos de queso</a>
                                                </li>                                                        
                                                ...
                                                <li role="presentation" class="">
                                                    <a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Eliminar tipos de queso</a>
                                                </li>
                                            </ul>
                                            <div id="myTabContent" class="tab-content">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    ...
                                                    <input type="text"  style="width: 90%" name="txtCheeseType" id="txtCheeseType"/>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                                    <ul>
                                                        ...
                                                        $cheeseType = $cheeseTypeBusiness->getAllTBCheeseType();
                                                        $maxEs = sizeof($cheeseType);
                                                        for ($j = 0; $j < $maxEs; $j++) {
                                                            $currentCheese = $cheeseType[$j];
                                                            ?>
                                                            <form id="frmDelete" method="POST" action="../BusinessAdmin/CheeseTypeAction.php" enctype="multipart/form-data">
                                                                <li><label style="width: 50%;"><?php echo $currentCheese->getCheeseType(); ?></label>
                                                                    <input type="submit" id="btnDelete" name="btnDelete" value="Eliminar"></li><br>
                                                                <input type="hidden" name="idCheeseType" value="<?php echo $currentCheese->getIdCheeseType(); ?>" />
