...
<html lang="en">
    <head>
        ...
        $result = $cheeseTypeBusiness->getAllTBCheeseType();
        ?>
    </head>
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active">
                                                <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Reconocimientos</a>
                                            </li>
                                            <li role="presentation" class="">
                                                <a href="adminCreateDeleteCheeseType.php">Administrar tipos de queso</a>
                                            </li>
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                <ul style="list-style: none;">
                                                    <?php
                                                    foreach ($result as $currentCheeseType) {
                                                        ?> 
                                                        <form method="POST" action="../BusinessAdmin/CheeseTypeAction.php">
                                                            <li><input style="border:none; width: 80%;" type="text" name="txtCheeseType" value="<?php echo $currentCheeseType->getCheeseType(); ?>"/></li>
                                                            <input type="hidden" name="idCheeseType" value="<?php echo $currentCheeseType->getIdCheeseType(); ?>" />                                           
                                                            <input type="submit" value="Actualizar" name="update" onclick="return validateFieldsProducts()"/><br>
