...
<html lang="en">
    ...
    <body class="nav-md">
        ...
        $resultProduct = $productBusiness->getProductById($id);
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <form id="frmInformation" method="POST" action="../BusinessAdmin/ProductAction.php" enctype="multipart/form-data">
                                            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                                ...
                                                <li role="presentation" class=""><a href="adminImagesProducts.php?id=<?php echo $id; ?>">Imágenes</a>
                                                </li>
                                            </ul>
                                            <div id="myTabContent" class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                    <div>
                                                        <label>Nombre:</label>
                                                        <input class="form-control" type="text" id="txtNameProduct" name="txtNameProduct" value="<?php echo $resultProduct->getNameProduct(); ?>">
                                                    </div>                                                
                                                    <div>
                                                        <label>Descripción:</label>
                                                        <textarea id="txtDescription" name="txtDescription" class="form-control" rows="8" ><?php echo $resultProduct->getDescriptionProduct(); ?></textarea>                                                    
                                                    </div>                                                   

                                                    <div>
                                                        <lable>Tipo de queso <?php echo $resultProduct->getCheeseType(); ?></lable>                                                        
                                                        <select id="cheeseType" name="cheeseType" class="form-control">
                                                            <?php
                                                            foreach ($resultCheese as $currentType) {
                                                                if (strcmp($currentType->getCheeseType(), $resultProduct->getCheeseType()) === 0) {
                                                                    echo '<h1>entro</h1>';
                                                                    ?>
                                                    ...
                                                    <div>
                                                        <lable>Tipo de crema <?php echo $resultProduct->getCreamType(); ?></lable>                                                      
                                                        <select id="creamType" name="creamType" class="form-control">
                                                            <?php
                                                            foreach ($resultCream as $currentCream) {
                                                                if (strcmp($currentCream->getCreamType(), $resultProduct->getCreamType()) === 0) {
                                                                    ?>
