...
<head>
        ...
        <!-- WEBSITE TITLE -->
        <title>Vojon - HTML5 Responsive Restaurant Template</title>
        ...
        <div class="wrapper">
            ...
            <nav class="navigation-section navbar navbar-default bootsnav">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">vojon</a>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="about-thumb">
                                <img src="StyleMain/images/chef-2.png" class="img-responsive" width="360" height="427" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <form class="reservation-form row" id="reservation-form" action="https://revolthemes.net/demo/vojon/html/inc/reservation.php" name="contactform" method="post">
                                <div class="col-sm-6">
            ...
            <div class="section menu-section" id="menu">
                <div class="container">
                    ...
                    <div class="row">
                        <ul class="filter-nav">
                            <li class="button active milestone-counter" data-category="all">All dishes <b class="stat-count highlight">72</b></li>
                            <li class="button milestone-counter" data-category="breakfast">Breakfast <b class="stat-count highlight">25</b></li>
                            <li class="button milestone-counter" data-category="lunch">Lunch <b class="stat-count highlight">15</b></li>
                            <li class="button milestone-counter" data-category="dinner">Dinner <b class="stat-count highlight">20</b></li>
                            <li class="button milestone-counter" data-category="dessert">Dessert <b class="stat-count highlight">12</b></li>
                        </ul>
                    </div>
                    <div class="row">
                        <div class="menu gallery">
                            ...
                            <div class="menu-items col-sm-3 lunch" data-category="metalloid">
                                <a href="StyleMain/images/menu/menu-2.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-2.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Fresh Juices</h2>
                                         <h3>$26</h3>
                                    </div>
                            ...
                            <div class="menu-items col-sm-3 dinner" data-category="post-transition">
                                <a href="StyleMain/images/menu/menu-3.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-3.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Chicken Mojamo</h2>
                                         <h3>$13</h3>
                                    </div>
                                </a>
                            </div>
                            <div class="menu-items col-sm-3 dessert" data-category="post-transition">
                                <a href="StyleMain/images/menu/menu-4.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-4.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Zoozoo Chicken</h2>
                                         <h3>$30</h3>
                                    </div>
                                </a>
                            </div>
                            <div class="menu-items col-sm-3 breakfast" data-category="transition">
                                <a href="StyleMain/images/menu/menu-5.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-5.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Lasagna Mermer</h2>
                                         <h3>$46</h3>
                                    </div>
                                </a>
                            </div>
                            <div class="menu-items col-sm-3 lunch" data-category="alkali">
                                <a href="StyleMain/images/menu/menu-6.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-6.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Garbo Chicken</h2>
                                         <h3>$83</h3>
                                    </div>
                            ...
                            <div class="menu-items col-sm-3 dinner" data-category="alkali">
                                <a href="StyleMain/images/menu/menu-7.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-7.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Beef Mirchi</h2>
                                         <h3>$51</h3>
                                    </div>
                            ...
                            <div class="menu-items  col-sm-3 dessert" data-category="transition">
                                <a href="StyleMain/images/menu/menu-8.jpg" data-gal="prettyPhoto[gallery1]">
                                    <img src="StyleMain/images/menu/menu-8.jpg" width="270" height="270" alt="">
                                    <div class="menu-item">
                                         <h2>Barbique Delite</h2>
                                         <h3>$77</h3>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="cl-sm-12 load-more-btn">
                            <p><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i> Load More</a></p>
                        </div>
                    </div>
                </div><!-- end of /.container -->
                        ...
                        <div class="col-lg-12">
                            <div id="carousel">
                                ...
                                <div id="testimonial-carousel" class="owl-carousel owl-theme">
                                    <div class="item">
                                        <img src="StyleMain/images/client1.png" width="130" height="130" alt=""><!-- Testimonial profile image -->
                                    ...
                                    <div class="item">
                                        <img src="StyleMain/images/client2.png" width="130" height="130" alt=""><!-- Testimonial profile image -->
                                        <div class="testimonial-caption">
                                    ...
                                    <div class="item">
                                        <img src="StyleMain/images/client3.png" width="130" height="130" alt=""><!-- Testimonial profile image -->
                                        <div class="testimonial-caption">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="about-profile">
                                <img src="StyleMain/images/team/01.png" width="270" height="270" alt="">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="about-profile">
                                <img src="StyleMain/images/team/02.png" width="270" height="270" alt="">
                                <div class="profile-details">
                                    <div class="about-social">
                                        <a href="#"><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i></a>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="about-profile">
                                <img src="StyleMain/images/team/03.png" width="270" height="270" alt="">
                                <div class="profile-details">
                                    <div class="about-social">
                                        <a href="#"><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i></a>
                         ...
                         <div class="col-md-3 col-sm-6">
                            <div class="about-profile">
                                <img src="StyleMain/images/team/04.png" width="270" height="270" alt="">
                                <div class="profile-details">
                                    <div class="about-social">
                                        <a href="#"><i class="fa fa-facebook"></i></a>
                                        <a href="#"><i class="fa fa-twitter"></i></a>
            ...
            <section class="section project-counter-section">
                <div class="container">
                    <div class="row">
                        <div class="section-title-box col-md-6 col-md-offset-3">
                            <h1>Some Fun fact</h1><!-- title -->
                            <span class="title-divider"><i class="fa fa-cutlery" aria-hidden="true"></i> </span>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab.</p>
                        </div><!-- end of /.section title box -->
                    </div><!-- end of/.row -->
            ...
            <div class="section recipe-section" id="blog">
                <div class="container">
                    <div class="row">
                        <div class="section-title-box col-md-6 col-md-offset-3">
                            <h1>Our Blog</h1><!-- end section title -->
                            <span class="title-divider"><i class="fa fa-cutlery" aria-hidden="true"></i> </span>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab.</p>
                        </div><!-- end of /.section title box  -->
                    </div><!-- end of.row -->
                    <div id="recipe-carusel" class="owl-carousel recipe ">
                        <figure class="item">
                            <div class="blog-item col-xs-6">
                                <img src="StyleMain/images/blog/blog-1.jpg" width="285" height="283" alt="">
                                <p>17 aug 16</p>
                                <a href="#">Read More</a>
                            </div>
                            <div class="title-box col-xs-6">
                                <div class="blog-title">
                                    <div class="title-cell">
                                        <a href="#">
                                            <h2>The Perfect Chiken</h2>
                                        </a>
                                    </div>
                                </div>
                            </div>
                        </figure><!-- end of /.blog item -->

                        <figure class="item">
                            <div class="blog-item col-xs-6">
                                <img src="StyleMain/images/blog/blog-2.jpg" width="285" height="283" alt="">
                                <p>17 aug 16</p>
                                <a href="#">Read More</a>
                            </div>
                            <div class="title-box col-xs-6">
                        ...
                        <figure class="item">
                            <div class="blog-item col-xs-6">
                                <img src="StyleMain/images/blog/blog-3.jpg" width="285" height="283" alt="">
                                <p>17 aug 16</p>
                                <a href="#">Read More</a>
                            </div>
                            <div class="title-box col-xs-6">
                        ...
                        <figure class="item">
                            <div class="blog-item col-xs-6">
                                <img src="StyleMain/images/blog/blog-4.jpg" width="285" height="283" alt="">
                                <p>17 aug 16</p>
                                <a href="#">Read More</a>
                            </div>
                            <div class="title-box col-xs-6">
                    ...
                    </div><!-- end of /.blog slider -->
                    <div class="customNavigation">
                      <a class="recipe-prev"><i class="fa fa-angle-left"></i></a>
                      <a class="recipe-next"><i class="fa fa-angle-right"></i></a>
                    </div><!-- end navigation control -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 contact-box">
                            <form class="row" id="contact-form" action="https://revolthemes.net/demo/vojon/html/inc/contact.php" name="contactform" method="post" >
